...
contract SlothToken is ERC223("Sloth token", "SLOTH"), Ownable {
    ...
    constructor() {
        ...
        _owner = msgSender;
        //_mint(msgSender, 120000000 * 10 ** 18);
        //_moveDelegates(address(0), _delegates[msgSender], 120000000 * 10 ** 18);
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "Sloth::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "Sloth::delegateBySig: invalid nonce");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "Sloth::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "Sloth::_writeCheckpoint: block number exceeds 32 bits");
